        ...
        <div className="hidden sm:flex flex-wrap justify-center items-center mt-4 mx-4 gap-4 py-4 bg-dark-black shadow-lg rounded-md" >
          <div className='w-56 shadow-md pointer-cursor'>
            <div className='w-full flex flex-col justnify-center items-center gap-4'>
              <img src={hackerearth} className='w-full h-36 bg-cover bg-no-repeat bg-center rounded-lg shadow-md bg-light-blue hover:cursor-pointer'/>
          ...
          <div className='w-56 shadow-md pointer-cursor'>
            <div className='w-full flex flex-col justify-center items-center gap-4'>
              <img src={codechef} className='w-full h-36 bg-cover bg-no-repeat bg-center rounded-lg shadow-md bg-light-blue hover:cursor-pointer'/>
          ...
          <div className='w-56 shadow-md pointer-cursor'>
            <div className='w-full flex flex-col justify-center items-center gap-4'>
              <img src={hackerrank} className='w-full h-36 bg-cover bg-no-repeat bg-center rounded-lg shadow-md bg-light-blue hover:cursor-pointer'/>
          ...
          <div className='w-56 shadow-md pointer-cursor'>
            <div className='w-full flex flex-col justify-center items-center gap-4'>
              <img src={leetcode} className='w-full h-36 bg-cover bg-no-repeat bg-center rounded-lg shadow-md bg-light-blue hover:cursor-pointer'/>
          ...
          <div className='w-56 shadow-md pointer-cursor'>
            <div className='w-full flex flex-col justify-center items-center gap-4'>
              <img src={codeforces} className='w-full h-36 bg-cover bg-no-repeat bg-center rounded-lg shadow-md bg-light-blue hover:cursor-pointer'/>
          ...
          <div className='w-56 shadow-md pointer-cursor'>
            <div className='w-full flex flex-col justify-center items-center gap-4'>
              <img src={kickstart} className='w-full h-36 bg-cover bg-no-repeat bg-center rounded-lg shadow-md bg-light-blue hover:cursor-pointer'/>
