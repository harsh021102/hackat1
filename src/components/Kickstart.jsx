...
const Kickstart = () => {
  ...
  return (
    <div className='flex-1 mt-4 w-full h-full  bg-light-black overflow-auto gap-2 mb-8'>
        <h1 className='flex justify-center items-center text-3xl text-white font-bold font-inter py-4 bg-dark-black border-b-4 border-dark-blue mx-2 rounded-md shadow-lg mb-4'>Kickstart ({filterArray.length})</h1>
        <Heading/>
